...
static float declinationAngle = 0.082;        //magnetic declination angle
...
//SoftwareSerial ss(TXPin, RXPin);     // Serial connection to the GPS module; increase buffer size to 512
...
*/
    ...
    timer.setInterval(5000L, periodicUpdate);
    // put target on map
