...
#include <Adafruit_PWMServoDriver.h>              // motor driver
...
#include <MovingAveragePlus.h>                       // simple moving average class; for Sonar functionality
...
MovingAveragePlus<int, 3> sonarAverage(MAX_DISTANCE_IN);       // moving average of last n pings, initialize at MAX_DISTANCE_IN
*/
